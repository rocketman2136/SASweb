...
declare interface Polymer {
    ...
    FlattenedNodesObserver: Constructor<IFlattenedNodeObserver>;

}

declare interface IFlattenedNodeObserver {
    (target: Node, callback: (info: IFlattenedNodeObserverInfo) => void): void;
    connect(): void;
    disconnect(): void;
    _schedule(): void;
    _processMutations(mutations: any): void;
    _processSlotMutations(mutations: any): void;
    flush(): void;
    _listenSlots(nodeList: Array<Node>): void;
    _unlistenSlots(nodeList: Array<Node>): void;
}

declare interface IFlattenedNodeObserverInfo {
    target: Node;
...
declare class PolymerElement extends PolymerMetaEffects {
    ...
    rootPath: string;
    _observer: IFlattenedNodeObserver;
}
...
declare interface IPolymerTemplateItem {}

declare interface IPolymerMouseEventModel {
    item: IPolymerTemplateItem;
}

declare interface IPolymerMouseEvent extends MouseEvent {
    model: IPolymerMouseEventModel;
}

declare interface IPolymerArrayMutation<T> {
    path: string;
    value: any;
    base: T[];
}